<nav class="bg-gray-800">
            ...
            <div class="relative ml-3">
              <?php if(isset($_SESSION['user']['id'])) : ?>
                ...
                <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                  ...
                  <form action="/logout" method="POST" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">
              ...
              <?php else: ?>
                <a href="/register" class="text-slate-300">Register Here</a>
                <span class="text-slate-600 font-bold"> || </span>
                <a href="/login" class="text-slate-300">Login Here</a>
              <?php endif; ?>
            </div>
          </div>
        </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <?php else : ?>
          <a href="/register" class="px-3 text-slate-200">Register Here</a>
        <?php endif; ?>
      </div>
    </div>
  </nav>