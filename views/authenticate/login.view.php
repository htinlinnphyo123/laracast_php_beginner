  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="/login" method="POST">
      <div>
        ...
        <div class="mt-2">
          <input
            ...
            value="<?= old('email')  ?>">
          <?php if(isset($errors['invalid_format'])) : ?>
            <p class="text-red-400"><?= $errors['invalid_format'] ?></p>
          <?php endif ; ?>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="password" name="password" type="string" autocomplete="current-password" class="px-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
        ...
        <?php if(isset($errors['not_match'])) : ?>
          <p class="text-red-400"><?= $errors['not_match'] ?></p>
        <?php endif; ?>
      <div>
